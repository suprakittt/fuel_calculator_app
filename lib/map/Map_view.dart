...
class _MapViewState extends State<MapView> {
  CameraPosition _initialLocation = CameraPosition(target: LatLng(13.7563, 100.5018));
                          ...
                          child: IconButton(
                            ...
                            onPressed: () async {
                              ...
                              await Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => CalculationWidget(index: 10,),
                                ),
                              );
                            },
                          )
                              ...
                              _calculateDistance().then((isCalculated) {
                                if (isCalculated) {
                                  ...
                                  ScaffoldMessenger.of(context)
                                    ...
                                    SnackBar(
                                      content: Text(
                                          'Error Calculating Distance, try inputting location name based on the google maps'),
                                    ),
                                  );
                                }
                              });
